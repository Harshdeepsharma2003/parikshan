...
<body>
    ...
    <main>
        ...
        <section class="hero-section">
            <div class="container">
                <div class="hero-content">
                    <div class="hero-text">
                        <h1>Master Your Skills with <span class="brand-highlight">Parikshan</span></h1>
                        <p class="hero-subtitle">Advanced online testing platform with real-time proctoring, multiple question formats, and instant results. Experience the future of digital assessments.</p>
                        ...
                        <div class="cta-buttons">
                            <a href="register.jsp" class="btn btn-primary">Take Your First Test Now</a>
                            <a href="register.jsp" class="btn btn-secondary">Learn More</a>
                        </div>
                    </div>
                        ...
                        <div class="hero-illustration">
                            <div class="test-window">
                                <div class="window-header">
                                    ...
                                    <span class="window-title">Parikshan Test</span>
                                </div>
                                <div class="question-preview">
                                    <h4>Question 1 of 10</h4>
                                    <p>Which of the following is correct?</p>
                                    <div class="options">
                                        <div class="option selected">A) Option A</div>
            ...
            <div class="container">
                ...
                <div class="steps-grid">
                    <div class="step-card">
                        ...
                        <p>Create your account and grant camera/microphone permissions for secure proctoring</p>
                        <div class="time-info">
                ...
                <div class="proctoring-info">
                    ...
                    <div class="info-card">
                        ...
                        <p>Audio monitoring detects any unauthorized communication</p>
                    </div>
                    <div class="info-card">
                        <i class="fas fa-shield-alt"></i>
        ...
        <section class="test-formats">
            <div class="container">
                <h2 class="section-title">Test Format</h2>
